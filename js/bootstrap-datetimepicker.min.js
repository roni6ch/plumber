...
(function (a) {
    ...
    var i = function (l, k) {
        ...
        this.minuteStep = k.minuteStep || this.element.data("minute-step") || 30;
        ...
        this.icons = {
            leftArrow: this.fontAwesome ? "fa-arrow-left" : (this.bootcssVer === 3 ? "glyphicon-arrow-left" : "fa fa-chevron-right"),
            rightArrow: this.fontAwesome ? "fa-arrow-right" : (this.bootcssVer === 3 ? "glyphicon-arrow-right" : "fa fa-chevron-left")
        };
        ...
        constructor: i, _events: [], _attachEvents: function () {
            ...
            for (var B = 0; B < 24; B++) {
                ...
                if (this.showMeridian && a[this.language].meridiem.length == 2) {
                    ...
                    w = B + ":00";
                    if (B > 8 && B < 20) {
                        s.push('<span class="hour' + v + '" value="'+ w.split(":")[0]+'">' + w + "</span>");
                    }
                }
            ...
            //TODO: FROM HERE THE MINUTES STARTS
            s = [];
             w = "", F = "", t = "";
